...
public class PGAMutation implements MutationBehavior{
	...
	public void mutation(GeneticAlgorithm ga) {
			...
			for(int i3=0;i3<ga.getPoplation();i3++){
				ga.PGAdata[ga.getCurrentgeneration()][island].crossover[i3]=new String(tmp[i3]);
				System.out.println("NewPop3["+i3+"]="+ga.PGAdata[ga.getCurrentgeneration()][island].crossover[i3]);
